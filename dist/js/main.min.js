"use strict";$((function(){var s,e,n=$("header"),t=$(".header .header-content"),c=$(".lower-header"),a=$(".upper-header"),i=$(".hamburger-icon"),o=$(".lower-header .nav-item .nav-link"),r=$(".link-search");function l(){s=t.innerHeight(),c.innerHeight(),a.innerHeight(),e=menu.innerWidth()}function d(){n.hasClass("sticky")?$("body").css("padding-top",s+100):$("body").css("padding-top",0),menu.css("top",s)}function m(){menu.animate({left:"".concat(menu.hasClass("show")?0:-e)},200)}function p(){outLContainer.offset().left,outLContainer.offset().reight;if(window.innerWidth<768)$("#menu").multilevelpushmenu({container:$("#menu"),fullCollapse:!0,collapsed:!1,mode:"cover",backText:"Back",backItemClass:"backItemClass",backItemIcon:"fa fa-angle-left",groupIcon:""}),e=menu.innerWidth(),l(),d(),m(),outLContainer.css("margin-left",0);else{l();var s=outLContainer.offset().left;outLContainer.offset().reight;outLContainer.css("margin-left",-s)}}menuLink=$("#menu .nav-list a"),menu=$("#menu"),outLContainer=$(".out-lcontainer"),homeProducts=$(".home-products-li"),productSelect=$(".product-select"),o.on("click",(function(){$(this).parent().addClass("active").siblings().removeClass("active")})),menuLink.on("click",(function(){$(this).parent().addClass("active").siblings().removeClass("active")})),menu.css("left",-e),i.on("click",(function(){$(this).find(".icon").toggleClass("fa-arrow-left  fa-bars"),menu.toggleClass("show"),m(),$(this).find(".icon").hasClass("fa-arrow-left")?r.fadeOut(100):r.fadeIn(100)})),$(window).on("scroll",(function(){menu.hasClass("show")&&i.click(),$(this).scrollTop()>100?n.not(".sticky")&&(n.addClass("sticky"),a.addClass("d-none"),l(),d()):n.hasClass("sticky")&&(n.removeClass("sticky"),a.removeClass("d-none"),l(),d())}));var u=$(".colors-types .slick-slider");function g(s){var e=s[0].colors,n=s[1].selectedimg,t=n.src,c=n.srcset,a=n.name,i=n.deg;e.map((function(s){var e=s.backgroundColor,n=s.name,t=s.deg,c="background-color:".concat(e),a="<div class='slider-item' data-name=".concat(n," data-deg=").concat(t," id=").concat(n," style=").concat(c,'>\n                             <span class="name">').concat(n,'</span>\n                             <div class=\'selected-container\'>\n                             <img src="imgs/selected.jpg"\n                             srcset="imgs/selected@2x.jpg 2x,\n                                     imgs/selected@3x.jpg 3x"\n                             class="Selected">\n                              </div>\n                             <span class="deg">').concat(t,"</span>\n                            </div>");u.append(a)}));var o="<div class='slider-item latte-img' data-name=".concat(a," data-deg=").concat(i," >\n                                <img src=").concat(t,"\n                                alt=").concat(a,"\n                                srcset=").concat(c,'/>\n\n                                <div class="latte-desc"> \n                                    <span class="name">').concat(a,'</span>\n                                    <div class=\'selected-container\'>\n                                    <img src="imgs/selected.jpg"\n                                    srcset="imgs/selected@2x.jpg 2x,\n                                            imgs/selected@3x.jpg 3x"\n                                    class="Selected">\n                                     </div>\n                                    <span class="deg">').concat(i,"</span>\n                                </div>\n\n                         </div>");u.find("#Truffle").after(o),u.slick({vertical:!0,infinite:!0,slidesToShow:5,slidesToScroll:1,prevArrow:".colors-types .prev-arrow",nextArrow:".colors-types .next-arrow",responsive:[{breakpoint:768,settings:{vertical:!1,arrows:!1,centerMode:!0,slidesToShow:1,slidesToScroll:1}}]}),$(".colors-types .slider-item").on("click",(function(){$(this).toggleClass("select")}))}function v(s){var e=$(".lipsStick .slick-slider");s.map((function(s){var n=s.src,t=s.srcset,c="<div class='slider-item'>\n            <img src=".concat(n,"\n            srcset=").concat(t,"\n           />\n           </div>");e.append(c)})),$(".lipsStick .slick-slider").slick({slidesToShow:1,slidesToScroll:1,arrows:!1,dots:!0,autoplay:!0,pauseOnHover:!0})}productSelect.text(homeProducts.attr("data-path")),$.ajax({type:"Get",url:"https://my-json-server.typicode.com/sajidaqadomi/productsjson/db",data:"",dataType:"jsonp",success:function(s){var e=s.lips,n=s.lipstickimgs,t=s.relateditems;g(e),v(n),function(s){var e=$(".related-item .slick-slider");s.map((function(s){var n=s.src,t=s.srcset,c=s.name,a=s.mark,i=s.type,o='<div class="card-wrapper">\n             \n              <div class="card text-center"">\n            <div class=\'img-container card-img-top\'> \n              <img class="img" src='.concat(n,"  srcset=").concat(t," alt=").concat(c,'>\n            </div>\n           \n            <div class="card-body">\n              <h5 class="card-title name">').concat(c,'</h5>\n              \n            </div>\n            <div class="card-footer">\n            <h6 class="card-subtitle mb-2 text-muted type">').concat(i,'</h6>\n              <p class="desc">').concat(a,"</p>\n            </div>\n            <div class='cart icon'><img src='imgs/cart(2).svg' alt='cart'></div>\n          </div>\n          \n           \n            </div>");e.append(o)})),function(s){s.slick({slidesToShow:3,slidesToScroll:1,centerMode:!0,arrows:!1,dots:!1,cssEase:!0,centerPadding:"45px",responsive:[{breakpoint:768,settings:{vertical:!1,arrows:!1,slidesToShow:1,slidesToScroll:1}}]})}(e)}(t)},error:function(s,e,n){console.log(lipstickimgs)}}),l(),p(),$(window).on("resize",(function(){p(),d()}))}));
