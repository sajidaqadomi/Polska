"use strict";$((function(){var e=$("header"),a=$(".header .header-content"),n=$(".lower-header"),s=$(".upper-header"),i=$(".hamburger-icon"),t=$(".lower-header .nav-item .nav-link"),o=$(".search-area .search"),c=$("#menu .nav-list a"),l=$("#menu"),r=a.innerHeight(),h=(n.innerHeight(),s.innerHeight(),l.innerWidth());t.on("click",(function(){$(this).parent().addClass("active").siblings().removeClass("active")})),console.log(c),c.on("click",(function(){$(this).parent().addClass("active").siblings().removeClass("active")})),o.focus((function(){console.log("focus"),$(this).parent(".search-area").find(".input-effect").animate({width:"100%"},200)})),o.blur((function(){console.log("focus"),$(this).parent(".search-area").find(".input-effect").animate({width:"0%"},200)})),l.css("left",-h),i.on("click",(function(){$(this).find(".icon").toggleClass("fa-arrow-left  fa-bars"),l.toggleClass("show"),l.animate({left:"".concat(l.hasClass("show")?0:-h)},300)})),$(window).on("scroll",(function(){l.hasClass("show")&&i.click(),$(this).scrollTop()>r?e.not(".sticky")&&(e.addClass("sticky"),s.addClass("d-none")):e.hasClass("sticky")&&(e.removeClass("sticky"),s.removeClass("d-none"))})),window.innerWidth<=768&&$("#menu").multilevelpushmenu({container:$("#menu"),fullCollapse:!0,collapsed:!1,mode:"cover",backText:"Back",backItemClass:"backItemClass",backItemIcon:"fa fa-angle-left",groupIcon:""})}));
