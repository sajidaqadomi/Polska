"use strict";$((function(){var e=$("header"),s=$(".header .header-content"),a=$(".lower-header"),n=$(".upper-header"),l=$(".hamburger-icon"),o=$("#menu"),t=s.innerHeight(),c=(a.innerHeight(),n.innerHeight(),o.innerWidth());o.css("left",-c),l.on("click",(function(){$(this).find(".icon").toggleClass("fa-arrow-left  fa-bars"),o.toggleClass("show"),o.animate({left:"".concat(o.hasClass("show")?0:-c)},300)})),$(window).on("scroll",(function(){o.hasClass("show")&&l.click(),$(this).scrollTop()>t?e.not(".sticky")&&(e.addClass("sticky"),n.addClass("d-none")):e.hasClass("sticky")&&(e.removeClass("sticky"),n.removeClass("d-none"))})),window.innerWidth<=768&&$("#menu").multilevelpushmenu({container:$("#menu"),fullCollapse:!0,collapsed:!1,mode:"cover",backText:"Back",backItemClass:"backItemClass",backItemIcon:"fa fa-angle-left",groupIcon:""})}));
