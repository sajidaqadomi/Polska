"use strict";$((function(){var n,e,s=$("header"),a=$(".header .header-content"),i=$(".lower-header"),t=$(".upper-header"),o=$(".hamburger-icon"),c=$(".lower-header .nav-item .nav-link"),l=$(".link-search");function r(){n=a.innerHeight(),i.innerHeight(),t.innerHeight(),e=menu.innerWidth()}function u(){menu.css("top",n)}function d(){menu.animate({left:"".concat(menu.hasClass("show")?0:-e)},200)}function m(){window.innerWidth<=768&&($("#menu").multilevelpushmenu({container:$("#menu"),fullCollapse:!0,collapsed:!1,mode:"cover",backText:"Back",backItemClass:"backItemClass",backItemIcon:"fa fa-angle-left",groupIcon:""}),e=menu.innerWidth(),r(),u(),d())}menuLink=$("#menu .nav-list a"),menu=$("#menu"),c.on("click",(function(){$(this).parent().addClass("active").siblings().removeClass("active")})),menuLink.on("click",(function(){$(this).parent().addClass("active").siblings().removeClass("active")})),menu.css("left",-e),o.on("click",(function(){$(this).find(".icon").toggleClass("fa-arrow-left  fa-bars"),menu.toggleClass("show"),d(),$(this).find(".icon").hasClass("fa-arrow-left")?l.fadeOut(100):l.fadeIn(100)})),$(window).on("scroll",(function(){menu.hasClass("show")&&o.click(),$(this).scrollTop()>n?s.not(".sticky")&&(s.addClass("sticky"),t.addClass("d-none"),r(),u()):s.hasClass("sticky")&&(s.removeClass("sticky"),t.removeClass("d-none"),r(),u())})),r(),m(),$(window).on("resize",(function(){m(),r(),u()}))}));
