"use strict";$((function(){var e=$("header"),n=$(".header .header-content"),s=$(".lower-header"),a=$(".upper-header"),i=$(".hamburger-icon"),o=$(".lower-header .nav-item .nav-link"),t=($(".search-area .search"),$("#menu .nav-list a")),l=$("#menu"),c=(n.innerHeight(),s.innerHeight(),a.innerHeight(),l.innerWidth());function r(){console.log(c),l.animate({left:"".concat(l.hasClass("show")?0:-c)},200)}function h(){window.innerWidth<=768&&($("#menu").multilevelpushmenu({container:$("#menu"),fullCollapse:!0,collapsed:!1,mode:"cover",backText:"Back",backItemClass:"backItemClass",backItemIcon:"fa fa-angle-left",groupIcon:""}),c=l.innerWidth(),r())}o.on("click",(function(){$(this).parent().addClass("active").siblings().removeClass("active")})),t.on("click",(function(){$(this).parent().addClass("active").siblings().removeClass("active")})),l.css("left",-c),i.on("click",(function(){$(this).find(".icon").toggleClass("fa-arrow-left  fa-bars"),l.toggleClass("show"),r()})),$(window).on("scroll",(function(){l.hasClass("show")&&i.click(),$(this).scrollTop()>200?e.not(".sticky")&&(e.addClass("sticky"),a.addClass("d-none")):e.hasClass("sticky")&&(e.removeClass("sticky"),a.removeClass("d-none"))})),h(),$(window).on("resize",(function(){h()}))}));
