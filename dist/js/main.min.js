"use strict";$((function(){var e,s,n=$("header"),t=$(".header .header-content"),c=$(".lower-header"),a=$(".upper-header"),o=$(".hamburger-icon"),i=$(".lower-header .nav-item .nav-link"),l=$(".link-search");function r(){e=t.innerHeight(),c.innerHeight(),a.innerHeight(),s=menu.innerWidth()}function d(){n.hasClass("sticky")?$("body").css("padding-top",e+100):$("body").css("padding-top",0),menu.css("top",e)}function m(){menu.animate({left:"".concat(menu.hasClass("show")?0:-s)},200)}function u(){outLContainer.offset().left,outLContainer.offset().reight;if(window.innerWidth<768)$("#menu").multilevelpushmenu({container:$("#menu"),fullCollapse:!0,collapsed:!1,mode:"cover",backText:"Back",backItemClass:"backItemClass",backItemIcon:"fa fa-angle-left",groupIcon:""}),s=menu.innerWidth(),r(),d(),m(),outLContainer.css("margin-left",0);else{r();var e=outLContainer.offset().left;outLContainer.offset().reight;outLContainer.css("margin-left",-e)}}menuLink=$("#menu .nav-list a"),menu=$("#menu"),outLContainer=$(".out-lcontainer"),homeProducts=$(".home-products-li"),productSelect=$(".product-select"),i.on("click",(function(){$(this).parent().addClass("active").siblings().removeClass("active")})),menuLink.on("click",(function(){$(this).parent().addClass("active").siblings().removeClass("active")})),menu.css("left",-s),o.on("click",(function(){$(this).find(".icon").toggleClass("fa-arrow-left  fa-bars"),menu.toggleClass("show"),m(),$(this).find(".icon").hasClass("fa-arrow-left")?l.fadeOut(100):l.fadeIn(100)})),$(window).on("scroll",(function(){menu.hasClass("show")&&o.click(),$(this).scrollTop()>100?n.not(".sticky")&&(n.addClass("sticky"),a.addClass("d-none"),r(),d()):n.hasClass("sticky")&&(n.removeClass("sticky"),a.removeClass("d-none"),r(),d())}));var p=$(".colors-types .slick-slider");function g(e){var s=e[0].colors,n=e[1].selectedimg,t=n.src,c=n.srcset,a=n.name,o=n.deg;s.map((function(e){var s=e.backgroundColor,n=e.name,t=e.deg,c="background-color:".concat(s),a="<div class='slider-item' data-name=".concat(n," data-deg=").concat(t," id=").concat(n," style=").concat(c,'>\n                             <span class="name">').concat(n,'</span>\n                             <div class=\'selected-container\'>\n                             <img src="imgs/selected.jpg"\n                             srcset="imgs/selected@2x.jpg 2x,\n                                     imgs/selected@3x.jpg 3x"\n                             class="Selected">\n                              </div>\n                             <span class="deg">').concat(t,"</span>\n                            </div>");p.append(a)}));var i="<div class='slider-item latte-img' data-name=".concat(a," data-deg=").concat(o," >\n                                <img src=").concat(t,"\n                                alt=").concat(a,"\n                                srcset=").concat(c,'/>\n\n                                <div class="latte-desc"> \n                                    <span class="name">').concat(a,'</span>\n                                    <div class=\'selected-container\'>\n                                    <img src="imgs/selected.jpg"\n                                    srcset="imgs/selected@2x.jpg 2x,\n                                            imgs/selected@3x.jpg 3x"\n                                    class="Selected">\n                                     </div>\n                                    <span class="deg">').concat(o,"</span>\n                                </div>\n\n                         </div>");p.find("#Truffle").after(i),p.slick({vertical:!0,infinite:!0,slidesToShow:5,slidesToScroll:1,prevArrow:".colors-types .prev-arrow",nextArrow:".colors-types .next-arrow",responsive:[{breakpoint:768,settings:{vertical:!1,arrows:!1,centerMode:!0,slidesToShow:1,slidesToScroll:1}}]}),$(".colors-types .slider-item").on("click",(function(){$(this).toggleClass("select")}))}function f(e){var s=$(".lipsStick .slick-slider");e.map((function(e){console.log(e);var n=e.src,t=e.srcset,c="<div class='slider-item'>\n            <img src=".concat(n,"\n            srcset=").concat(t,"\n           />\n           </div>");s.append(c)})),$(".lipsStick .slick-slider").slick({slidesToShow:1,slidesToScroll:1,arrows:!1,dots:!0,autoplay:!0})}productSelect.text(homeProducts.attr("data-path")),$.ajax({type:"Get",url:"https://my-json-server.typicode.com/sajidaqadomi/productsjson/db",data:"",dataType:"jsonp",success:function(e){var s=e.lips,n=e.lipstickimgs;console.log(n),g(s),f(n)},error:function(e,s,n){console.log(lipstickimgs)}}),r(),u(),$(window).on("resize",(function(){u(),d()}))}));
