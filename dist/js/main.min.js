"use strict";$((function(){$("header");var s,e,n=$(".header .header-content"),c=$(".lower-header"),a=$(".upper-header"),t=$(".hamburger-icon"),i=$(".lower-header .nav-item .nav-link"),o=$(".link-search"),l=$("#menu .nav-list a"),r=$("#menu"),d=($(".out-lcontainer"),$(".home-products-li")),p=$(".product-select");function v(){s=n.innerHeight(),c.innerHeight(),a.innerHeight(),e=r.innerWidth(),e=r.innerWidth()}function m(){v(),r.css("top",s)}function u(){r.animate({left:"".concat(r.hasClass("show")?0:-e)},200)}function g(){v(),$("body").css("padding-top",s),r.css("left",-e),window.innerWidth<768&&($("#menu").multilevelpushmenu({container:$("#menu"),fullCollapse:!0,collapsed:!1,mode:"cover",backText:"Back",backItemClass:"backItemClass",backItemIcon:"fa fa-angle-left",groupIcon:""}),m(),u())}i.on("click",(function(){$(this).parent().addClass("active").siblings().removeClass("active")})),l.on("click",(function(){$(this).parent().addClass("active").siblings().removeClass("active")})),t.on("click",(function(){$(this).find(".icon").toggleClass("fa-arrow-left  fa-bars"),r.toggleClass("show"),u(),$(this).find(".icon").hasClass("fa-arrow-left")?o.fadeOut(100):o.fadeIn(100)}));var f=$(".colors-types .slick-slider");p.text(d.attr("data-path"));var h=$(".icon-minus"),k=$(".icon-plus"),w=$(".quantity .number");function C(s){var e=+w.text();s?w.text(++e):e&&w.text(--e)}function b(s){var e=s[0].colors,n=s[1].selectedimg,c=n.src,a=n.srcset,t=n.name,i=n.deg;e.map((function(s){var e=s.backgroundColor,n=s.name,c=s.deg,a="background-color:".concat(e),t="<div id=".concat(n,">\n            <div class='slider-item' data-name=").concat(n," data-deg=").concat(c,"  style=").concat(a,'>\n                             <span class="name">').concat(n,'</span>\n                             <div class=\'selected-container\'>\n                             <img src="imgs/selected.jpg"\n                             srcset="imgs/selected@2x.jpg 2x,\n                                     imgs/selected@3x.jpg 3x"\n                             class="Selected">\n                              </div>\n                             <span class="deg">').concat(c,"</span>\n                            </div>\n            </div>");f.append(t)}));var o="<div>\n        <div class='slider-item latte-img' data-name=".concat(t," data-deg=").concat(i," >\n                                <img src=").concat(c,"\n                                alt=").concat(t,"\n                                srcset=").concat(a,'/>\n\n                                <div class="latte-desc"> \n                                    <span class="name">').concat(t,'</span>\n                                    <div class=\'selected-container\'>\n                                    <img src="imgs/selected.jpg"\n                                    srcset="imgs/selected@2x.jpg 2x,\n                                            imgs/selected@3x.jpg 3x"\n                                    class="Selected">\n                                     </div>\n                                    <span class="deg">').concat(i,"</span>\n                                </div>\n                         </div>\n        </div>");f.find("#Truffle").after(o),f.slick({vertical:!0,infinite:!0,slidesToShow:5,slidesToScroll:1,prevArrow:".colors-types .prev-arrow",nextArrow:".colors-types .next-arrow",responsive:[{breakpoint:768,settings:{vertical:!1,arrows:!1,centerMode:!0,slidesToShow:1,slidesToScroll:1}}]});var l=$(".colors-types .slider-item");l.on("click",(function(){$(this).hasClass("select")?$(this).removeClass("select"):(l.removeClass("select"),$(this).addClass("select"))}))}function x(s){var e=$(".lipsStick .slick-slider");s.map((function(s){var n=s.src,c=s.srcset,a="<div class='slider-item'>\n            <img src=".concat(n,"\n            srcset=").concat(c,"\n           />\n           </div>");e.append(a)})),$(".lipsStick .slick-slider").slick({slidesToShow:1,slidesToScroll:1,arrows:!1,dots:!0,autoplay:!0,pauseOnHover:!0})}$.ajax({type:"Get",url:"https://my-json-server.typicode.com/sajidaqadomi/productsjson/db",data:"",dataType:"jsonp",success:function(s){var e=s.lips,n=s.lipstickimgs,c=s.relateditems;console.log(n),b(e),x(n),function(s){var e=$(".related-item .slick-slider");s.map((function(s){var n=s.src,c=s.srcset,a=s.name,t=s.mark,i=s.type,o='<div class="card-wrapper">\n             \n              <div class="card text-center"">\n            <div class=\'img-container card-img-top\'><img class="img" src='.concat(n,"  srcset=").concat(c," alt=").concat(a,'></div>\n            <div class="card-body">\n              <h5 class="card-title name">').concat(a,'</h5>\n              \n            </div>\n            <div class="card-footer">\n            <h6 class="card-subtitle type">').concat(i,'</h6>\n              <p class="desc">').concat(t,"</p>\n            </div>\n            <div class='cart icon'><img src='imgs/cart(2).svg' alt='cart'></div>\n          </div>\n          \n           \n            </div>");e.append(o)})),function(s){s.slick({slidesToShow:3.5,slidesToScroll:1,arrows:!1,dots:!1,cssEase:!0,infinite:!1,responsive:[{breakpoint:1024,settings:{slidesToShow:2.5}},{breakpoint:768,settings:{vertical:!1,arrows:!1,slidesToShow:1.5,slidesToScroll:1}}]})}(e)}(c)},error:function(s,e,n){}}),g(),h.on("click",(function(){return C(!1)})),k.on("click",(function(){return C(!0)})),$(window).on("resize",(function(){g(),m()})),$(window).on("scroll",(function(){r.hasClass("show")&&t.click(),$(this).scrollTop()>150?(a.addClass("d-none"),m()):(a.removeClass("d-none"),m())}))}));
