"use strict";$((function(){var e=$("header"),n=$(".header .header-content"),a=$(".lower-header"),s=$(".upper-header"),i=$(".hamburger-icon"),t=$(".lower-header .nav-item .nav-link"),o=$(".search-area .search"),c=$("#menu .nav-list a"),l=$("#menu"),r=(n.innerHeight(),a.innerHeight(),s.innerHeight(),l.innerWidth());function h(){console.log(r),l.animate({left:"".concat(l.hasClass("show")?0:-r)},200)}function d(){window.innerWidth<=768&&($("#menu").multilevelpushmenu({container:$("#menu"),fullCollapse:!0,collapsed:!1,mode:"cover",backText:"Back",backItemClass:"backItemClass",backItemIcon:"fa fa-angle-left",groupIcon:""}),r=l.innerWidth(),h())}t.on("click",(function(){$(this).parent().addClass("active").siblings().removeClass("active")})),c.on("click",(function(){$(this).parent().addClass("active").siblings().removeClass("active")})),o.focus((function(){console.log("focus"),$(this).parent(".search-area").find(".input-effect").animate({width:"100%"},200)})),o.blur((function(){console.log("focus"),$(this).parent(".search-area").find(".input-effect").animate({width:"0%"},200)})),l.css("left",-r),i.on("click",(function(){$(this).find(".icon").toggleClass("fa-arrow-left  fa-bars"),l.toggleClass("show"),h()})),$(window).on("scroll",(function(){l.hasClass("show")&&i.click(),$(this).scrollTop()>200?e.not(".sticky")&&(e.addClass("sticky"),s.addClass("d-none")):e.hasClass("sticky")&&(e.removeClass("sticky"),s.removeClass("d-none"))})),d(),$(window).on("resize",(function(){d()}))}));
