"use strict";$((function(){var e=$("header"),s=$(".header .header-content"),a=$(".lower-header"),n=$(".upper-header"),l=$(".hamburger-icon"),i=$(".lower-header .nav-item .nav-link"),t=$("#menu"),o=s.innerHeight(),c=(a.innerHeight(),n.innerHeight(),t.innerWidth());i.on("click",(function(){$(this).parent().addClass("active").siblings().removeClass("active")})),t.css("left",-c),l.on("click",(function(){$(this).find(".icon").toggleClass("fa-arrow-left  fa-bars"),t.toggleClass("show"),t.animate({left:"".concat(t.hasClass("show")?0:-c)},300)})),$(window).on("scroll",(function(){t.hasClass("show")&&l.click(),$(this).scrollTop()>o?e.not(".sticky")&&(e.addClass("sticky"),n.addClass("d-none")):e.hasClass("sticky")&&(e.removeClass("sticky"),n.removeClass("d-none"))})),window.innerWidth<=768&&$("#menu").multilevelpushmenu({container:$("#menu"),fullCollapse:!0,collapsed:!1,mode:"cover",backText:"Back",backItemClass:"backItemClass",backItemIcon:"fa fa-angle-left",groupIcon:""})}));
