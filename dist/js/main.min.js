"use strict";$((function(){var s,e,n=$("header"),c=$(".header .header-content"),a=$(".lower-header"),t=$(".upper-header"),i=$(".hamburger-icon"),o=$(".lower-header .nav-item .nav-link"),l=$(".link-search"),r=$("#menu .nav-list a"),d=$("#menu"),p=$(".out-lcontainer"),m=$(".home-products-li"),v=$(".product-select");function g(){s=c.innerHeight(),a.innerHeight(),t.innerHeight(),e=d.innerWidth(),p.offset().left,e=d.innerWidth()}function f(){g(),d.css("top",s)}function u(){d.animate({left:"".concat(d.hasClass("show")?0:-e)},200)}function h(){g();var s=+$(".container").css("padding-left").slice(0,-2),n=$(".container").offset().left;window.innerWidth<768?(d.css("left",-e),u(),p.css("margin-left",0)):p.css("margin-left",-(n+s))}o.on("click",(function(){$(this).parent().addClass("active").siblings().removeClass("active")})),r.on("click",(function(){$(this).parent().addClass("active").siblings().removeClass("active")})),i.on("click",(function(){$(this).find(".icon").toggleClass("fa-arrow-left  fa-bars"),d.toggleClass("show"),u(),$(this).find(".icon").hasClass("fa-arrow-left")?l.fadeOut(100):l.fadeIn(100)}));var k=$(".colors-types .slick-slider");function w(s){var e=s[0].colors,n=s[1].selectedimg,c=n.src,a=n.srcset,t=n.name,i=n.deg;e.map((function(s){var e=s.backgroundColor,n=s.name,c=s.deg,a="background-color:".concat(e),t="<div class='slider-item' data-name=".concat(n," data-deg=").concat(c," id=").concat(n," style=").concat(a,'>\n                             <span class="name">').concat(n,'</span>\n                             <div class=\'selected-container\'>\n                             <img src="imgs/selected.jpg"\n                             srcset="imgs/selected@2x.jpg 2x,\n                                     imgs/selected@3x.jpg 3x"\n                             class="Selected">\n                              </div>\n                             <span class="deg">').concat(c,"</span>\n                            </div>");k.append(t)}));var o="<div class='slider-item latte-img' data-name=".concat(t," data-deg=").concat(i," >\n                                <img src=").concat(c,"\n                                alt=").concat(t,"\n                                srcset=").concat(a,'/>\n\n                                <div class="latte-desc"> \n                                    <span class="name">').concat(t,'</span>\n                                    <div class=\'selected-container\'>\n                                    <img src="imgs/selected.jpg"\n                                    srcset="imgs/selected@2x.jpg 2x,\n                                            imgs/selected@3x.jpg 3x"\n                                    class="Selected">\n                                     </div>\n                                    <span class="deg">').concat(i,"</span>\n                                </div>\n\n                         </div>");k.find("#Truffle").after(o),k.slick({vertical:!0,infinite:!0,slidesToShow:5,slidesToScroll:1,prevArrow:".colors-types .prev-arrow",nextArrow:".colors-types .next-arrow",responsive:[{breakpoint:768,settings:{vertical:!1,arrows:!1,centerMode:!0,slidesToShow:1,slidesToScroll:1}}]}),$(".colors-types .slider-item").on("click",(function(){$(this).toggleClass("select")}))}function C(s){var e=$(".lipsStick .slick-slider");s.map((function(s){var n=s.src,c=s.srcset,a="<div class='slider-item'>\n            <img src=".concat(n,"\n            srcset=").concat(c,"\n           />\n           </div>");e.append(a)})),$(".lipsStick .slick-slider").slick({slidesToShow:1,slidesToScroll:1,arrows:!1,dots:!0,autoplay:!0,pauseOnHover:!0})}v.text(m.attr("data-path")),$.ajax({type:"Get",url:"https://my-json-server.typicode.com/sajidaqadomi/productsjson/db",data:"",dataType:"jsonp",success:function(s){var e=s.lips,n=s.lipstickimgs,c=s.relateditems;w(e),C(n),function(s){var e=$(".related-item .slick-slider");s.map((function(s){var n=s.src,c=s.srcset,a=s.name,t=s.mark,i=s.type,o='<div class="card-wrapper">\n             \n              <div class="card text-center"">\n            <div class=\'img-container card-img-top\'> \n              <img class="img" src='.concat(n,"  srcset=").concat(c," alt=").concat(a,'>\n            </div>\n           \n            <div class="card-body">\n              <h5 class="card-title name">').concat(a,'</h5>\n              \n            </div>\n            <div class="card-footer">\n            <h6 class="card-subtitle mb-2 text-muted type">').concat(i,'</h6>\n              <p class="desc">').concat(t,"</p>\n            </div>\n            <div class='cart icon'><img src='imgs/cart(2).svg' alt='cart'></div>\n          </div>\n          \n           \n            </div>");e.append(o)})),function(s){s.slick({slidesToShow:3,slidesToScroll:1,centerMode:!0,arrows:!1,dots:!1,cssEase:!0,centerPadding:"45px",responsive:[{breakpoint:768,settings:{vertical:!1,arrows:!1,slidesToShow:1,slidesToScroll:1}}]})}(e)}(c)},error:function(s,e,n){console.log(lipstickimgs)}}),$("#menu").multilevelpushmenu({container:$("#menu"),fullCollapse:!0,collapsed:!1,mode:"cover",backText:"Back",backItemClass:"backItemClass",backItemIcon:"fa fa-angle-left",groupIcon:""}),h(),$(window).on("resize",(function(){h(),f()})),$(window).on("scroll",(function(){d.hasClass("show")&&i.click(),$(this).scrollTop()>150?n.not(".sticky")&&(n.addClass("sticky"),t.addClass("d-none"),f()):n.hasClass("sticky")&&(n.removeClass("sticky"),t.removeClass("d-none"),f())}))}));
